...
export default function Footer() {
  return (
    <div className='h-[200px] flex justify-center footer'>
        <div className='w-[60%] flex flex-col justify-center'>
            <div className='flex items-center justify-center'>
                ...
                <div onClick={()=> router.push('/')} className='cursor-pointer'>
                    <h2 className='text-white text-[25px] font-[Montserrat] font-semibold'>Infomatics</h2>
                </div>
            </div>
            <p></p>
            <div className='w-[100%] p-[5px] flex items-center justify-center'>
                <ul className='flex justify-around w-[50%] text-white'>
                    <li className='inline border rounded-full border-[rgba(255,255,255,0.3)] p-[7px] ease-in-out duration-150 transition-[border-color] hover:border-[rgba(255,255,255,0.9)]'>
        ...
        <div className='font-[roboto] flex items-center justify-center mt-[10px] text-white'><AiOutlineCopyright style={{paddingRight: '3px'}}/>Copyright 2022. Infomatics.com.ng. All rights reserved</div>
        </div>
    </div>
  )
}
